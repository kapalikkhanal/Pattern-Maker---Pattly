...
const BlobGenerator = (
    ...
    return (
        <div className="relative w-full bg-[#242424] m-10 flex flex-col items-center justify-center rounded-md">
            <div
                ref={containerRef}
                className="relative flex justify-center items-center rounded-lg border overflow-hidden z-50 m-12"
            ...
            <div className='absolute inset-0 -bottom-6 flex items-end justify-center w-full z-10 mt-12'>
